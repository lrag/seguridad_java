...
public class ExpedientesDaoImpl implements ExpedientesDao, InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		guardar(new Expediente("Elvis esta vivo","Se asegura que el cantante estadounidense de rock no habría muerto realmente en 1977, y que vivir�a de incógnito viajando por el mundo. Dónde ha sido visto Elvis? En Montana, Cambridge, Southampton,...", "imagenes/elvis.jpg", "Mulder", false));
