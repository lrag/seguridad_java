...
public class Aplicacion_Proxy extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Aplicacion_Proxy frame = new Aplicacion_Proxy();
	...
	private void modificarUsuario(){
		...
		usuario.setPw(jtfPassword.getText());
		usuario.setRol(jtfRol.getText());
