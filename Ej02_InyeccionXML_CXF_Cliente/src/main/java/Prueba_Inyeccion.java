...
public class Prueba_Inyeccion {
	...
	/*
	 * En este ejemplo vamos a inyectar XML a nuestra petici�n, como las clases
	 * proxy que se generan hacen un saneamiento de la entrada, vamos a 
	 * usar una librer�a de m�s bajo nivel para hacer la peticion HTTP
	 */
	public static void main(String[] args) throws Exception {
		
		//Este ser�a un ejemplo de la petici�n anterior si capturaramos
		...
		*/
		...
		//vamos a hacer una conexi�n lo m�s pura posible, creando el mensaje HTTP 
		//que tenemos arriba
		...
		//Configuraci�n de la cabecera de la petici�n
