...
function login(){
	...
	let parametros = "username="+$("#username").val()+
	                 "&password="+$("#password").val()+
					 "&${_csrf.parameterName}=${_csrf.token}"	
	
    $.ajax( 
    	{ 
    	  'url'  : 'http://localhost:8080/SpringSecurity4_Session_REST/servicios/login?'+parametros,
          'type' : 'post'
    	}
    )
    .done((body,textStatus, jqXHR ) => loginExito())	
	.fail(loginFallo)
...
<body>
    ...
    <div class="text-center page-header">
        <h1>
            Login - Spring Security - Rest y HttpSession 
        </h1>
    </div>
