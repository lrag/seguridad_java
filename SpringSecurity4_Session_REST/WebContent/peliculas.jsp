...
let headers = null
let url = 'http://localhost:8080/SpringSecurity4_Session_REST/servicios/peliculas';
let peliculaSel;
...
function insertarPelicula(){
    ...
    //$.post
    $.ajax( { 'url'         : url+"?${_csrf.parameterName}=${_csrf.token}",			  
...
function modificarPelicula(){
    ...
    $.ajax( { 'url'         : url+"/"+peliculaSel.id+"?${_csrf.parameterName}=${_csrf.token}",
              'success'     : listarPeliculas,
              'error'       : procesarError,
              'type'        : 'put',
              'contentType' : 'application/json; charset=UTF-8',
...
<body>
    ...
    <div class="text-center page-header">
        <h1>
            Gestión de Peliculas - Spring Security - Rest y HttpSession 
        </h1>
    </div>
